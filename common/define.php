...
//     public function select_login($sqli) {
//         $check = mysqli_query($this->connect(),$sqli);
//         return mysqli_num_rows($check);
//     }
// // UPDATE
//     public function update1($table, $set, $where) {
//         $query_update = "UPDATE `".$table."` SET ".$set." WHERE ".$where."";
//         return mysqli_query($this->connect(),$query_update);
//     }

//     public function select_page($table, $what, $start, $limit) {
//         $query_select = "SELECT ".$what." FROM `".$table."` LIMIT ".$start.",".$limit."";
//         return mysqli_query($this->connect(),$query_select);
//     }

// // DELETE
//     public function delete_user($table, $where, $in) {
//         $query_del_user = "DELETE FROM `".$table."` WHERE `".$where."` IN (".$in.")";
//         return mysqli_query($this->connect(),$query_del_user);
//     }
// }
